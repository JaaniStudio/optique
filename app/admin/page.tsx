...
const cardConfigs = [
  ...
  { label: "Items in Stock", value: "totalStock", icon: Package, color: "bg-amber-50 text-amber-600" },
  { label: "Total Users", value: "totalUsers", icon: Users, color: "bg-violet-50 text-violet-600" },
] as const;
